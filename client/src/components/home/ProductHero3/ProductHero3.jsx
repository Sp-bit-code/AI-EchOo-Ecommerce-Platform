...
import "./ProductHero3.css";

const ProductHero3 = () => {
  const navigate = useNavigate();

  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-[#f4f6f9] to-[#eef1f4] py-24 my-8 mx-4 sm:mx-8 rounded-[3rem] shadow-sm border border-white/60 min-h-[850px] flex flex-col justify-start">
