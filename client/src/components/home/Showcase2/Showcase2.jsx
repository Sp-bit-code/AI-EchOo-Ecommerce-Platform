...
const Showcase2 = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-[#eef1f4] to-[#f4f6f9] py-24 my-8 mx-4 sm:mx-8 rounded-[3rem] shadow-sm border border-white/60 min-h-[850px] flex flex-col justify-start">
      ...
      <div className="absolute bottom-[-120px] left-0 w-full flex justify-center z-10 pointer-events-none">
        <motion.img
          src="/iphone-true.png"
