...
const PORTFOLIO_URL = "https://sparsh-portfolio-qokw.onrender.com/";
          ...
          <div className="lg:col-span-5 flex flex-col justify-between pr-0 lg:pr-12">
            ...
            <div>
              ...
              <div className="relative max-w-sm">
                ...
                <button
                  type="button"
                  className="absolute right-2 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-gradient-to-b from-gray-600 to-gray-800 shadow-md border border-white/10 flex items-center justify-center text-white hover:scale-105 transition-transform"
