  ...
  const getItemTotal = (item) => {
    return Number(
      item.itemTotal ||
        item.item_total ||
        item.total ||
        getItemPrice(item) * Number(item.quantity || 1)
    );
  };
                    ...
                    <tr key={order.id} className="hover:bg-gray-50">
                      <td className="px-4 py-3 sm:px-6 sm:py-4">
                        <div className="flex items-center justify-between gap-2">
                          ...
                          <div className="flex-shrink-0">
                            <span
                              className={`px-2 py-1 text-xs font-medium rounded-full whitespace-nowrap ${getPaymentColor(
                                paymentMethod
                              )}`}
                            >
                              {paymentMethod}
                      ...
                      <td className="px-6 py-4">
                        <div className="text-sm font-medium text-gray-900">
                          {order.userName || order.user_name || "N/A"}
                        </div>

                        <div className="text-sm text-gray-500">
                          {order.userEmail || order.user_email || "N/A"}
                        </div>
                      </td>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {safeFormatPrice(selectedOrder.total || 0)}
                      </p>
                    </div>
                  </div>
                </div>
                            ...
                            <div className="flex justify-between">
                              ...
                              <div className="text-right">
                                <p className="text-sm font-medium text-gray-900">
                                  {safeFormatPrice(getItemPrice(item))}
                                </p>

                                <p className="text-sm text-gray-500">
                                  Total: {safeFormatPrice(getItemTotal(item))}
                                </p>
                              </div>
                            </div>
                          </div>
                ...
                <div className="border-t pt-4">
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium">
                        {safeFormatPrice(selectedOrder.shipping || 0)}
                      </span>
                    </div>
                    ...
                    <div className="flex justify-between text-lg font-semibold border-t pt-2">
                      ...
                      <span>{safeFormatPrice(selectedOrder.total || 0)}</span>
                    </div>
                  </div>
                </div>
              </div>
