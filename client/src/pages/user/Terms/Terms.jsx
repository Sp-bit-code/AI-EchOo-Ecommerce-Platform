...
EchOo specialises in premium smart devices including iPhones, Mac computers, laptops, and accessories from all major brands. Our commitment is to deliver high-quality technology products paired with exceptional customer service.`,
  },
  {
    ...
    bullets: [
      "Apple iPhones and iOS devices",
      "Mac computers — MacBook, iMac, Mac Pro, Mac Studio",
  ...
  },
  {
    ...
    pairs: [
      [
        "Pricing",
        "All prices are shown in Indian Rupees (₹) and are subject to change without notice.",
      ],
      [
        "Order Acceptance",
        "Your order constitutes an offer to purchase. We reserve the right to refuse or cancel any order at our discretion.",
      ],
      [
        "Payment Methods",
        "We accept major credit/debit cards, UPI, net banking, and other methods as indicated at checkout.",
      ],
      [
        "Taxes",
        "Applicable GST or other taxes will be added to your order total at checkout.",
      ],
    ],
  },
  {
    ...
    pairs: [
      [
        "Shipping Times",
        "Estimated delivery times are shown at checkout and may vary by location.",
      ],
      [
        "Shipping Costs",
        "Costs are calculated based on weight, destination, and method selected.",
      ],
      [
        "Free Shipping",
        "Free standard shipping is available on orders above a certain value — see checkout for current threshold.",
      ],
      [
        "Order Tracking",
        "Tracking information will be sent to your registered email once your order ships.",
      ],
    ],
  },
  {
    ...
    pairs: [
      [
        "Return Window",
        "We offer a 30-day return policy for most items in original, unopened condition.",
      ],
      [
        "Refund Processing",
      ...
      [
        ...
        "Opened software, digital downloads, and personalised products are not eligible for return.",
      ],
      [
        "Defective Products",
        "Contact us immediately if you receive a defective product — we will arrange a replacement or full refund.",
      ],
    ],
  },
  {
    ...
    pairs: [
      ...
      [
        "Extended Warranty",
        "Optional extended warranty plans may be available for purchase at checkout.",
      ],
      [
        "Warranty Claims",
        "Contact the manufacturer directly for warranty claims or reach our support team for guidance.",
      ],
    ],
  },
  {
...
Our total liability for any claim arising out of these terms shall not exceed the amount you paid for the specific products giving rise to the claim.`,
  },
  {
    ...
    content:
      "We reserve the right to modify these terms at any time. We will notify registered users of significant changes by email or by posting a notice on our website. Continued use of EchOo after changes are posted constitutes your acceptance of the modified terms.",
  },
  {
    num: "11",
    ...
    >
      ...
      <div className="max-w-[900px] mx-auto px-4 sm:px-6 pt-6 pb-12">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <Link
            to="/support"
            className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/60 border border-white/80 text-sm font-medium text-gray-700 hover:bg-white shadow-sm transition-all"
          >
            <svg
              className="w-4 h-4"
              fill="none"
      ...
      <div className="max-w-[900px] mx-auto px-4 sm:px-6 space-y-4 mb-16">
        {sections.map((section) => (
          <div
            key={section.num}
            className="bg-white/40 backdrop-blur-xl border border-white/60 rounded-3xl overflow-hidden shadow-sm"
          >
            <button
              className="w-full flex items-center justify-between px-6 py-5 text-left"
              onClick={() =>
                setActiveSection(
                  activeSection === section.num ? null : section.num
                )
              }
            >
              <div className="flex items-center gap-4">
                <span className="text-xs font-bold text-gray-400 tracking-widest w-6">
                  {section.num}
                </span>
              ...
              <svg
                className={`w-4 h-4 text-gray-500 transition-transform ${
                  activeSection === section.num ? "rotate-180" : ""
                }`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                ...
                <div className="pt-4 text-sm text-gray-700 leading-relaxed">
                  ...
                  {section.pairs && (
                    <div className="space-y-3 mt-2">
                      {section.pairs.map(([key, value], index) => (
                        <div key={index}>
                  ...
                  {section.contact && (
                    <div className="space-y-3 mt-2">
                      ...
                      <Link
                        to="/support"
                        className="inline-flex items-center gap-2 mt-2 px-4 py-2 rounded-full bg-gray-900 text-white text-sm font-semibold hover:bg-gray-800 transition-colors"
                      >
                        Contact Support →
                      </Link>
                    </div>
