...
// 2. Create a Service, get Service ID
...
const faqs = [
  {
    ...
    a: 'After your order ships, you will receive a tracking email. You can also check your order status in your Profile under "My Orders".',
  },
  {
    q: "What is your return policy?",
    a: "We offer a 30-day hassle-free return policy for most items. Products must be in original condition and packaging.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes, all products carry their original manufacturer warranty. Extended warranty plans are available at checkout.",
  },
  {
    q: "Can I change or cancel my order?",
    a: "Orders can be modified or cancelled within 2 hours of placement. Contact us immediately via the form below if needed.",
  },
  {
    q: "Do you ship internationally?",
    a: "We currently ship within India. International shipping is coming soon. Stay tuned!",
  },
];
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 mb-14">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            <div
              key={index}
              className="bg-white/40 backdrop-blur-xl border border-white/60 rounded-3xl p-6 flex items-start gap-4 shadow-[0_4px_24px_rgba(0,0,0,0.04)]"
            >
          ...
          <div>
            ...
            <div className="space-y-3">
              {faqs.map((faq, index) => (
                <div
                  key={index}
                  className="bg-white/40 backdrop-blur-xl border border-white/60 rounded-2xl overflow-hidden shadow-sm"
                >
                  <button
                    onClick={() =>
